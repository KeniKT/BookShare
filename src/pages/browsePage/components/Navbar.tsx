// src/pages/browsePage/components/Navbar.tsx
import React, { useState } from 'react';
import ProfileDropdown from './ProfileDropdown'; // This Navbar will import its local ProfileDropdown
  ...
  return (
    <nav className="bg-white border-b border-gray-200 p-4 flex justify-between items-center shadow-sm">
      ...
      <div className="flex items-center space-x-6">
        <a href="/browse" className="text-gray-900 font-bold border-b-2 border-purple-600 pb-1">Browse</a>
